              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#0B1221]/80 via-[#0B1221]/20 to-transparent flex flex-col justify-end p-6 sm:p-8 text-white">
                ...
                <div className="mt-4 pt-4 border-t border-white/20 flex items-center justify-between">
                  <a 
                    ...
                    onClick={() => trackPhoneClick(CONTACT_INFO.phone, 'faq_sidebar_card')}
                    className="flex items-center gap-2 text-sm font-bold text-[#29B6F6] hover:text-white transition-colors"
                  >
                    <Phone size={16} /> Call {CONTACT_INFO.phone}
                  </a>
                  <Link 
                    href="/#quote" 
                    onClick={() => trackQuoteCTAClick('Get Quote', 'faq_sidebar_card')}
                    className="text-xs font-bold uppercase tracking-wider text-white underline underline-offset-4 hover:text-[#29B6F6]"
                  >
                    Get Quote &rarr;
                  </Link>
                </div>
      ...
      <section className="pb-20 px-6 bg-fluid-wave-fixed text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10 text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/#quote" 
              onClick={() => trackQuoteCTAClick('Contact Us Today', 'faq_bottom_banner')}
              className="inline-block px-10 py-4 bg-[#29B6F6] text-white text-lg font-bold rounded-2xl shadow-lg hover:bg-[#0042a3] transition-all text-center"
            >
              Contact Us Today
            </Link>
          </div>
